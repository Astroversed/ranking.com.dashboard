...
searchInput.addEventListener('input', function() {
  ...
  switch (selectedCourse) {
      ...
      case "4to Informática B":
          ...
          break;
      case "5to Informática":
          document.getElementById("inf5-table-container").style.display = "block";
          break;
      case "6to Informática":
          document.getElementById("inf6-table-container").style.display = "block";
          break;
      ...
      case "4to Enfermería":
          ...
          break;
      case "5to Enfermería":
          document.getElementById("enfer5-table-container").style.display = "block";
          break;
        case "6to Enfermería":
          document.getElementById("enfer6-table-container").style.display = "block";
          break;
      ...
      case "4to Gestión":
          ...
          break;
      case "5to Gestión":
          document.getElementById("gest5-table-container").style.display = "block";
          break;
      case "6to Gestión":
          document.getElementById("gest6-table-container").style.display = "block";
          break;
      ...
      case "4to Mercadeo":
          ...
          break;
      case "5to Mercadeo":
          document.getElementById("merc5-table-container").style.display = "block";
          break;
      case "6to Mercadeo":
          document.getElementById("merc6-table-container").style.display = "block";
          break;
      ...
      case "4to Modas":
          ...
          break;
      case "5to Modas":
          document.getElementById("moda5-table-container").style.display = "block";
          break;
      case "6to Modas":
          document.getElementById("moda6-table-container").style.display = "block";
          break;

      case "4to Ebanistería":
          document.getElementById("eban4-table-container").style.display = "block";
          break;
      case "5to Ebanistería":
          document.getElementById("eban5-table-container").style.display = "block";
          break;
      case "6to Ebanistería":
          document.getElementById("eban6-table-container").style.display = "block";
          break;
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  var passwordPopup = document.querySelector(".wrapper");
  var overlay = document.querySelector(".overlay");
  var isPasswordCorrect = false;
  var hasPasswordBeenEntered = false;
  ...
  var verCalificacionesButtons = document.querySelectorAll('[data-username]');
  verCalificacionesButtons.forEach(function(button) {
      button.addEventListener('click', function () {
          var username = this.dataset.username;
          if (!hasPasswordBeenEntered || username !== activeUsername) {
  ...
  var submitPasswordButton = document.getElementById('button');
  submitPasswordButton.addEventListener('click', function () {
      var passwordInput = document.getElementById('confirm_pw').value;

      var users = [
          { username: 'gilbert', password: 'astroversed2' },
      ];

      var user = users.find(u => u.username === activeUsername);
      ...
      if (user && passwordInput === user.password) {
          ...
          toggleBtn.disabled = false;
          setTimeout(enableToggleBtn, 7 * 60 * 1000);
      }
  });
...
for (var i = 1; i < rows.length; i++) {
    ...
    var promedio = Math.round(sum / count);

    cells[5].innerHTML = promedio;
}

const showPswIcon = document.getElementById("showPsw");
const hidePswIcon = document.getElementById("hidePsw");
const passwordField = document.getElementById("confirm_pw");

showPswIcon.addEventListener("click", function() {
    passwordField.type = "text";
    showPswIcon.style.display = "none";
    hidePswIcon.style.display = "block";
});

hidePswIcon.addEventListener("click", function() {
...
function closePasswordBox() {
  const passwordBox = document.querySelector(".wrapper");
